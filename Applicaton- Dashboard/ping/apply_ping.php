...
$_SESSION['referral_code']=$queries['referral'];
   ...
   $client_id = 'XXXXXXXXX';
    ...
    $redirect_uri = 'http://pingnetwork.in/apply_ping.php';
    ...
    <div class="checkbox single">
        <label>
            <label>
                ...
                I accept the Terms of Service and the revenue split of 70% to creator and 30% to PING Network, and authorize PING Network to send me an invitation on YouTube 
                                                                                             </label>
        </label>
    </div>
</div>
	...
	if (isset($_SESSION['token'])) {
      ...
      <center>Your application is received and we will contact you soon.</center>';
		/*print "<a style=' background: #95CFFF; border-radius: 5px; padding: 5px; ' class='logout' 
			href='http://pingnetwork.in/'>Back</a><br>";*/
...
if (isset($_GET['code'])) { 
    ...
    $referral_code=$_SESSION['referral_code'];
		...
		$node['field_network_name']['und'][0]['value'] = $network_name;
