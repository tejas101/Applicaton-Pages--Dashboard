...
$_SESSION['referral_code']=$queries['referral'];
    ...
    $redirect_uri = 'http://pingnetwork.in/apply_xonenetwork_arabic.php';
    ...
    if (!$client->getAccessToken() && !isset($_SESSION['token'])) {
      ...
      print '<base target="_blank" /><head><link href="google_auth_style.css" rel="stylesheet"> 
        ...
        <section id="intro" class="top dark-bg img-bg-center img-bg-soft" style="background-image: url(http://xonenetwork.com/template02001001.jpg);">
            ...
            <div class="row">
                <div class="col-lg-7 col-md-8 col-sm-10 center-block">
                    <header>
                        ...
                        <p>
                           هل أنت على استعداد لتمرير قناتك للمستوى التالي؟ سواء كنت بدأت للتو في الطريق إلى الشهرة، أو كنت  من المخضرمين تبحث عن صفقات تجارية 
                           وفرص خارج يوتيوب، لدينا فريق وأدوات تأخذك إلى حيث تريد.
                        </p>
                    </header>
                </div>
            </div>
        ...
        <div class="container inner-top-xs inner-bottom-md">
            ...
            <div class="row">
                <div class="col-lg-7 col-md-8 col-sm-10 center-block animated">
                    ...
                    <p dir="rtl"> يرجى ملىء النموذج أدناه، وسنقوم بمراجعة طلبك في غضون يومي عمل.</p>
...
<div class="form-group ">
        ...
        <label for="first_name" style=" float: right; ">الإسم</label>
...
<div class="form-group ">
        ...
        <label for="channel_url" style=" float: right; ">رابط القناة</label>
    ...
    <div class="form-group ">
        ...
        <label for="first_name" style=" float: right; ">رقم الدفع الإلكتروني  </label>
        <input class="form-control" name="PayPal_ID" type="text" id="PayPal_ID">
        
</div>

<div class="form-group ">
    <label for="agree" style=" float: right; ">شروط الخدمة</label>
...
PING Digital Broadcast Pvt Ltd (PING) a company formed under the 

companies act 1956 India, whose registered office is at 318,Adhyaru 

Industrial Estate, Sun Mill Compound, Opp Phoenix Mills, Lower Parel, 

India with a branch office Ping Digital Broadcast Pvt Ltd BFC, UAE  

(hereinafter called `PING\'), on the other hand, with regard to the YouTube 

channel(s) broadcast over the internet (collectively, the "Properties") 

described in the application (the "Application") submitted to PING 

Network. By accepting these Terms, you covenant and agree to be bound 

by the Application and the Terms (collectively, the "Agreement").
...
by the parties hereto, the parties hereto hereby agree as follows:</p>

<p>1. Properties/Content. Content Provider represents and warrants that 
...
<p>2. License. Content Provider hereby grants to PING Network the exclusive, 

worldwide right and license, during the Term hereof, to exploit, manage 

and monetize (through enabling and selling advertising) the Properties 

and the Content as part of PING Network\'s branded YouTube network(s). 

Without limiting the foregoing, PING Network will have the exclusive right 

throughout the Term hereof to represent, sell and manage all advertising 

inventory pertaining to the Properties, including but not limited to any 

advertising sales and/or sponsorship opportunities, inclusion of 

advertising by advertising networks, use of annotations and related 

features, and the serving and monitoring of all advertising and/or 

sponsorship campaigns and programs. PING Network will collect all 

revenue generated from the Properties directly (e.g., through Ad Sense, 

Video Ad Sense, YouTube direct sales, PING Network\s direct sales, etc.) 

(collectively, the "Revenue"), and pay Content Provider its share of such 

Revenue in accordance with the terms of this Agreement. Without limiting 

the foregoing license, Content Provider further grants to PING Network 

any and all rights and licenses reasonably required for PING Network to 

perform and enjoy its rights under this Agreement.
...
further grant to PING Network the exclusive, worldwide right and 

license, during the Term hereof, to exploit, manage and monetize 

(through enabling and selling advertising) the Content via all forms of 

social media including but not limited to Facebook. In such cases, PING 

Network will collect all revenue generated from the Content directly 

from the social media source (e.g. Facebook), and pay Content Provider 

its share of such Revenue in accordance with the terms of this 
...
thirty percent (30%) to PING Network and seventy percent (70%) to 

Content Provider, respectively. PING Network will pay Content Provider its 

share of all Revenue due to Content Provider hereunder, if any, on a 

monthly basis in accordance with the terms of this Agreement, within 

thirty (30) days after the end of each calendar month; provided that a) if 

payment is made via PayPal, then the minimum monthly payment to 

Content Provider is Five dollar (US$5), and b) if payment is made via any 

means other than PayPal, then PING Network need not make payment to 

Content Provider hereunder until such time as there is an aggregate of at 

least one hundred dollars (US$100) due and payable to Content Provider 

hereunder. Notwithstanding anything to the contrary contained herein, 

PING Network may deduct from any and all Revenue otherwise payable to 

Content Provider hereunder all wire transfer fees, ACH fees, and other 

reasonable administrative fees (such administrative fees not to exceed 5% 

of the amount of Revenues payable to Content Provider in any given 

month) that are charged to PING Network in connection with the carrying 

out of its duties in accordance with this Agreement and/or otherwise 

incurred by PING Network in connection with monetizing the Properties 

and/or Content hereunder.
...
percent (50%) to PING Network and fifty percent (50%) to Content 

Provider, respectively. All other payment terms described in Paragraph 

3 above shall remain unchanged.</p>

<p>4. License to Use Intellectual Property. Content Provider also grants to 

PING Network a non-exclusive, worldwide, royalty-free license to use any 

trademarks, trade names, trade dress, slogans, designs, copyrights and/or 

logos that are provided by Content Provider in connection with the 

Properties and/or the Content in connection with PING Network\'s 

performance of its duties hereunder and/or in connection with PING 

Network\'s promotional activities.</p>

<p>5. Removal/Modification of Content. On occasion, PING Network may 

request that Content Provider remove certain Content or disable 
...
issued by PING Network via email or telephone call and must be handled 

with expediency by Content Provider. Notwithstanding the foregoing or 

anything contained herein to the contrary, PING Network has the right to 

terminate this Agreement upon written notice to Content Provider if it is 

determined by PING Network, in PING Network\'s sole discretion, that 

Content Provider has uploaded and/or received a ‘strike\' for copyrighted 

material in violation of YouTube terms of use, and/or for any reason 

whatsoever.</p>

<p>6. Term of Agreement. This Agreement shall begin on the Effective Date 
...
any third party, Content Provider shall immediately notify PING Network 

in writing of same. Content Provider\'s failure to send such notification 

may result in suspension from YouTube and the termination of this 

Agreement.

If any Content contains visibly prominent paid advertisements or 

sponsorships, Content Provider shall immediately notify PING Network in 
...
otherwise in violation of YouTube terms of use; PING Network shall have 

no obligation to make payments to Content Provider for any Properties 

that have not been ad-enabled by Content Provider.
...
<p>10. Assignment. PING Network shall have the right to assign this 
...
provide to PING Network i) advance written notice of such sale, and ii) any 

information about the new owner, including but not limited to name, 

address, payment details and tax information, which PING Network may 

reasonably request in order to fulfill its obligations under this Agreement.</p>
...
"impression fraud"). If PING Network believes in good faith that Content 

Provider has violated this Section, PING Network may (i) withhold 

payments to Content Provider until such suspected fraud is resolved and 

remedied to PING Network\'s satisfaction, and/or (ii) immediately 
...
and understood that PING Network reserves the right to reject any 

Application for any or no reason.</p>
...
rights of any person entity; (iv) PING Network\'s performance of activities 

contemplated herein will not infringe upon the rights of, or require the 

consent of, any third party or parties; and (iv) Content Provider will not 

include in the Properties any Content that violates (a) YouTube\'s or PING 

Network\'s terms of use or (b) the terms of this Agreement. Content 

Provider agrees to indemnify, defend and hold PING Network and its 

employees, agents, representatives, principals, managers, members, 

contractors and affiliates harmless from and against any and all claims, 

actions, liabilities, damages, costs and expenses (including, without 

limitation, reasonable attorneys\' fees and costs) arising out of or relating 

to the inaccuracy, incompleteness or breach of any of Content Provider\'s 

representations, warranties or agreements contained herein.</p>
...
Mumbai, India and shall be governed by internal laws of India. Subject to 

the mandatory binding arbitration provisions set forth above, only the 

courts in Mumbai,India shall have jurisdiction over controversies 
...
<p>18. Limitation of Remedies. No act or omission on the part of PING 

Network shall constitute a breach or default of this Agreement unless 

Content Provider shall first notify PING Network in writing and PING 

Network has not commenced to cure such default within twnty one (21) 

business days from its receipt of such written notice. In the event of any 

such default or breach, Content Provider acknowledges and agrees that it 

shall be limited to its remedy at law for money damages, if any, actually 

and proximately caused by such breach, and Content Provider shall not 

have the right to: (i) terminate or rescind this Agreement or any rights, 

privileges or benefits granted or licensed hereunder, or (ii) seek injunctive 

or other equitable relief, or (iii) enjoin or restrain the exhibition, 

distribution, broadcast, use, advertising, promotion or other exploitation 

of any of the Properties or Content or any elements thereof or other 
...
written, with respect to the subject matter hereof.</p>

<p>Agreed to with force and effect from and as of the Effective Date.</p>  
</div><div class="clear" style="clear: both;"></div><!-- clear -->
</div>
<div class="form-group ">
	...
	if (isset($_SESSION['token'])) {
      ...
      <center>Your application is received and we will contact you soon.</center>';
		/*print "<a style=' background: #95CFFF; border-radius: 5px; padding: 5px; ' class='logout' 
			href='http://xonenetwork.com/'>Back</a><br>";*/
...
if (isset($_GET['code'])) { 
    ...
    $referral_code=$_SESSION['referral_code'];
		...
		$node['field_network_name']['und'][0]['value'] = 'XoneNetwork';
